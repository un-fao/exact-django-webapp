...
Last activity: 2026-08-05 - Completed quick task 260805-ncv: fixed the orphaned-account cleanup in LoginExistingUserView, which passed a Firebase UID where the accounts:delete endpoint requires an ID token, so the cleanup never ran
