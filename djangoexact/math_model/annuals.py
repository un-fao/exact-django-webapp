...
def residue_burning(area_start, area, time_impl, time_cap, rate_coefficient, nitrous_constant, methane_constant, ef_methane_agr_residues_main, combustion_factor_main, 
    ...
    ag_residue_main = residue_main_tier_2 * 1000 if residue_main_tier_2 else yield_value_main * 1000 * n_estimation_slope_main + n_estimation_intercept_main
    ...
    ag_residue_minor = residue_minor_tier_2 * 1000 if residue_minor_tier_2 else yield_value_minor * 1000 * n_estimation_slope_minor + n_estimation_intercept_minor if yield_value_minor else 0
