...
class Livestock():
    ...
    def __init__(self, time_impl, time_cap, rate,  methane_constant, head_number_start, head_number_end, 
                   ...
                   ef_prp_methane_start, ef_prp_methane_end, percentage_prp_default_start, percentage_prp_default_end, percentage_prp_tier_2_start, percentage_prp_tier_2_end, ef_system_methane_start, ef_system_methane_end, ch4_prp_tier_2_start, ch4_prp_tier_2_end, ch4_system_default_start, ch4_system_default_end, ch4_system_tier_2_start, ch4_system_tier_2_end, # METHANE MANURE MANAGEMENT EMISSIONS PARAMETERS
                   ...
                   ef_prp_nitrous_direct_start, ef_prp_nitrous_direct_end, ef_system_nitrous_direct_start, ef_system_nitrous_direct_end, n2o_prp_tier_2_start_direct, n2o_prp_tier_2_end_direct,n2o_system_direct_default_start, n2o_system_direct_default_end,n2o_system_direct_tier_2_start, n2o_system_direct_tier_2_end,  ner_start, ner_end, # NITROUS OXIDE MANURE MANAGEMENT EMISSIONS PARAMETERS DIRECT
                   ef_prp_nitrous_indirect_volatization_start, ef_prp_nitrous_indirect_volatization_end, ef_system_nitrous_indirect_volatization_start, ef_system_nitrous_indirect_volatization_end, n2o_prp_tier_2_start_indirect_volatization, n2o_prp_tier_2_end_indirect_volatization, n20_system_indirect_volatization_default_start, n20_system_indirect_volatization_default_end, n20_system_indirect_volatization_tier_2_start,  n20_system_indirect_volatization_tier_2_end,# NITROUS OXIDE MANURE MANAGEMENT EMISSIONS PARAMETERS INDIRECT VOLATIZATION
                   ef_prp_nitrous_indirect_leaching_start, ef_prp_nitrous_indirect_leaching_end, ef_system_nitrous_indirect_leaching_start, ef_system_nitrous_indirect_leaching_end, n2o_prp_tier_2_start_indirect_leaching, n2o_prp_tier_2_end_indirect_leaching, n20_system_indirect_leaching_default_start, n20_system_indirect_leaching_default_end, n20_system_indirect_leaching_tier_2_start, n20_system_indirect_leaching_tier_2_end # NITROUS OXIDE MANURE MANAGEMENT EMISSIONS PARAMETERS INDIRECT LEACHING
                 ):
    ...
    def calculate_emissions(self):
        ...
        def calculate_methane_manure_management_emissions():
                ...
                try:
                    ...
                    self.mmm_emissions_yearly = yearly_time_dependent_parameter_breakdown(ch4_head_start, ch4_head_end, self.time_impl, self.time_cap, self.rate)
        ...
        def calculate_nitrous_manure_management_direct():
            ...
            try:
                ...
                self.nmm_direct_emissions_yearly = yearly_time_dependent_parameter_breakdown(n2o_head_start, n2o_head_end, self.time_impl, self.time_cap, self.rate)
        ...
        def calculate_nitrous_manure_management_indirect_volatization():
            ...
            try:
                ...
                self.nmm_indirect_volatization_emissions_yearly = yearly_time_dependent_parameter_breakdown(n2o_head_start, n2o_head_end, self.time_impl, self.time_cap, self.rate)
        ...
        def calculate_nitrous_manure_management_indirect_leaching():
            ...
            try:
                ...
                self.nmm_indirect_leaching_emissions_yearly = yearly_time_dependent_parameter_breakdown(n2o_head_start, n2o_head_end, self.time_impl, self.time_cap, self.rate)
