...
class Inputs(BaseModule):
    def __init__(self, unit_start, unit_end, rate_type, ipcc_factor_co2, tier_2_factor_co2, unit_factor_co2, emissions_factor_co2, time_impl, time_cap, ipcc_factor_n2o, tier_2_factor_n2o, unit_factor_n2o, emissions_factor_n2o, ipcc_factor_eq, tier_2_factor_eq, unit_factor_eq, emissions_factor_eq):
    ...
    def calculate_emissions(self):
        try:
            if self.unit_factor_co2 is None or self.emissions_factor_co2 is None:
                ...
                self.yearly_co2_eq_emissions, self.total_co2_eq_emissions = input_single_calculation(self.unit_start, self.unit_end, self.ipcc_factor_co2, self.tier_2_factor_co2, self.unit_factor_co2, self.emissions_factor_co2, self.time_impl, self.time_cap, self.rate_type)
            ...
            if self.unit_factor_n2o is None or self.emissions_factor_n2o is None:
                ...
                self.yearly_n2o_emissions, self.total_n2o_emissions = input_single_calculation(self.unit_start, self.unit_end, self.ipcc_factor_n2o, self.tier_2_factor_n2o, self.unit_factor_n2o, self.emissions_factor_n2o, self.time_impl, self.time_cap, self.rate_type)
            ...
            if self.unit_factor_eq is None or self.emissions_factor_eq is None:
                ...
                self.yearly_co2_emissions, self.total_co2_emissions = input_single_calculation(self.unit_start, self.unit_end, self.ipcc_factor_eq, self.tier_2_factor_eq, self.unit_factor_eq, self.emissions_factor_eq, self.time_impl, self.time_cap, self.rate_type)
...
class Roads(BaseModule):
    def __init__(self, ef_ipcc: float, ef_tier_2, area, time_impl, time_cap, rate_type):
