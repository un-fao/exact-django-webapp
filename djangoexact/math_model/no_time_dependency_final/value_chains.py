...
class ValueChain(BaseModule):
    ...
    input_coefficient_multiplier: Optional[float]
    ...
    def calculate_emissions(self):
        ...
        emissions_start = (total_quantity_start * self.emission_factor_start) * (1 + self.transmission_loss_start)
        emissions_end = total_quantity_end * self.emission_factor_end * (1 + self.transmission_loss_end)
