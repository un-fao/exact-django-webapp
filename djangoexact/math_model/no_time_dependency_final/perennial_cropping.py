...
class PerennialCropping:
    ...
    def __init__(self, area_start, area_end, time_impl, time_cap, rate, 
                    ...
                    soc_start_default, soc_end_default, soc_start_tier_2,
                    ...
                    flu_end_tier_2, fi_start_default, fi_end_default, fi_start_tier_2, fi_end_tier_2, calculate_soc_som, delay
                    ):
    ...
    def calculate_emissions(self,):
        ...
        def calculate_som():
            ...
            try:
                if self.calculate_soc_som:
                    self.yearly_som_emissions, self.total_som_emissions = som_emissions(self.soc_end, self.soc_start, self.emission_factor_burning_nitrous, self.nitrous_constant,
                                                                                        self.hectars_before_20)
        ...
        def calculate_soil():
            ...
            try:
                if self.calculate_soc_som:
                    self.yearly_soil_emissions, self.total_soil_emissions = soil_emissions_2(self.soc_start, self.soc_end, self.total_hectars, self.area_start, 
