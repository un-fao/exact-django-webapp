...
def calculate_emissions(area_start, area_w, area_wo, EFc_ref, EFc_tier_2, SFw_ref, SFw_tier_2, SFp_ref, SFp_tier_2, SFo_ref, SFo_tier_2, yield_ref, rice_slope, rice_intercept, straw_tonnes_tier_2, methane_ef, rice_cf, nitrous_ef, nitrous_constant,
                        time_impl, time_cap, rate_coefficient_w, methane_constant, cultivation_period_ref, cultivation_period_tier_2, rate_coefficient_wo, rate_type_w, rate_type_wo,  socref, soc_tier_2, f_lu_ref, f_lu_tier_2, f_i_ref, f_i_tier_2, f_mg_ref, f_mg_tier_2
                        ):
    ...
    if area_start == 0 and area_w == 0 and area_wo == 0:
        ...
        straw_tonnes_ref = rice_yield * rice_slope + rice_intercept if not straw_tonnes_tier_2 else straw_tonnes_tier_2
    
    ch4_emitted_w = ch4_emitted(area_start, area_w, time_impl, time_cap, rate_coefficient_w, methane_constant, cultivation_period_ref, cultivation_period_tier_2, adjusted_daily_ef_methane_ref)
    ch4_emitted_wo = ch4_emitted(area_start, area_wo, time_impl, time_cap, rate_coefficient_wo, methane_constant, cultivation_period_ref, cultivation_period_tier_2, adjusted_daily_ef_methane_ref)

    straw_burning_w = straw_burning(area_start, area_w, time_impl, time_cap, rate_coefficient_w, straw_tonnes_ref, rice_cf, methane_ef, methane_constant, nitrous_ef, nitrous_constant, straw_tonnes_ref, straw_tonnes_tier_2)
    straw_burning_wo = straw_burning(area_start, area_wo, time_impl, time_cap, rate_coefficient_wo, straw_tonnes_ref, rice_cf, methane_ef, methane_constant, nitrous_ef, nitrous_constant, straw_tonnes_ref, straw_tonnes_tier_2)

    soil_co2_change_w = soil_co2_change(area_start, area_w, time_impl, time_cap, rate_coefficient_w, rate_type_w, socref, soc_tier_2, f_lu_ref, f_lu_tier_2, f_i_ref, f_i_tier_2, f_mg_ref, f_mg_tier_2)
    soil_co2_change_wo = soil_co2_change(area_start, area_wo, time_impl, time_cap, rate_coefficient_wo, rate_type_wo, socref, soc_tier_2, f_lu_ref, f_lu_tier_2, f_i_ref, f_i_tier_2, f_mg_ref, f_mg_tier_2)

    total_w = ch4_emitted_w + straw_burning_w + soil_co2_change_w
    total_wo = ch4_emitted_wo + straw_burning_wo + soil_co2_change_wo
...
def ch4_emitted(area_start, area, time_impl, time_cap, rate_coefficient, methane_constant, cultivation_period_ref, 
                cultivation_period_tier_2, daily_ef_methane):
