...
class GrasslandDefaults(Defaults):
    ...
    def get_defaults(self, calculate=False) -> dict:
        ...
        return SimpleNamespace(
            ...
            agb_t2_start_default=defaults.biomass.agb_t_dm_ha,
            agb_t2_w_default=defaults.biomass.agb_t_dm_ha,
            agb_t2_wo_default=defaults.biomass.agb_t_dm_ha,
            bgb_t2_start_default=defaults.biomass.bgb_t_dm_ha,
            bgb_t2_w_default=defaults.biomass.bgb_t_dm_ha,
            bgb_t2_wo_default=defaults.biomass.bgb_t_dm_ha,
