...
class GrasslandDefaults(Defaults):
    ...
    def get_defaults(self, calculate=False) -> dict:
        ...
        return SimpleNamespace(
            soc_t2_start_default=defaults.soc_start.value or self.input.activity.soc,
            soc_t2_w_default=defaults.soc_w.value or self.input.activity.soc,
            soc_t2_wo_default=defaults.soc_wo.value or self.input.activity.soc,
