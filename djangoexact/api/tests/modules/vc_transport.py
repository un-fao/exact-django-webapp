...
class ValueChainTransportTest(t.ModuleWithSubmodulesTest):
    def __init__(self):
        super().__init__()
        self.module_type = ModuleType.objects.get(class_name="Transport")
        self.submodule_types = [
            ModuleType.objects.get(class_name="TransportEntry"),
        ]
        self.create_module()
