...
class GrasslandToPerenial(t.LandUseChangeTest):
    def __init__(self):
        ...
        self.module_type_w = ModuleType.objects.get(class_name="PerennialCropping")
        ...
        self.module_end: PerennialCropping = self.create_module(self.module_type_w, land_use_change=self.land_use_change, land_use_type_start=fuzzy.FuzzyChoice(self.trees).fuzz(), land_use_type_wo=fuzzy.FuzzyChoice(self.trees).fuzz(), land_use_type_w=fuzzy.FuzzyChoice(self.trees).fuzz())
