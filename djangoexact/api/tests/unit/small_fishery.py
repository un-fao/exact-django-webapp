...
class SmallFisheryTestCase(base_module.BaseModuleTestCase):
    def setUp(self):
        self.ModuleClass = models.SmallFishery
        super().setUp()
        ...
        self.validated_data = {
            "gear_type_start": models.SmallFisheryGearType.objects.order_by("?").first().id,
            "gear_type_w": models.SmallFisheryGearType.objects.order_by("?").first().id,
            "gear_type_wo": models.SmallFisheryGearType.objects.order_by("?").first().id,
            ...
            "fishery_type": models.FisheryType.objects.order_by("?").first().id,
        }
