...
class PerennialCroplandTestCase(base_module.BaseModuleTestCase):
    def setUp(self):
        ...
        self.validated_data = {
            ...
            "biomass_t2_start": FuzzyFloat(0, 100).fuzz(),
            "biomass_t2_w": FuzzyFloat(0, 100).fuzz(),
            "biomass_t2_wo": FuzzyFloat(0, 100).fuzz(),
            "agb_t2_start": FuzzyFloat(0, 100).fuzz(),
            "agb_t2_w": FuzzyFloat(0, 100).fuzz(),
            "agb_t2_wo": FuzzyFloat(0, 100).fuzz(),
            "bgb_t2_start": FuzzyFloat(0, 100).fuzz(),
            "bgb_t2_w": FuzzyFloat(0, 100).fuzz(),
            "bgb_t2_wo": FuzzyFloat(0, 100).fuzz(),
            "agb_max_t2_start": FuzzyFloat(0, 100).fuzz(),
            "agb_max_t2_w": FuzzyFloat(0, 100).fuzz(),
            "agb_max_t2_wo": FuzzyFloat(0, 100).fuzz(),
        }
    ...
    def test_modify_and_check_cache_invalidation(self):
        ...
        validated_data = copy.deepcopy(self.validated_data)
        validated_data["agb_t2_w"] = 100000
        response = self.edit_module(self.module, self.user, validated_data)
