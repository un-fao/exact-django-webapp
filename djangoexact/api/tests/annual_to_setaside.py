...
luc: LandUseChange = LandUseChangeFactory.create(
    activity=a,
    module_type_start=ModuleType.objects.get(class_name="AnnualCropping"),
    module_type_wo=ModuleType.objects.get(class_name="AnnualCropping"),
    module_type_w=ModuleType.objects.get(class_name="SetAside"),
)

annual_cropping: AnnualCropping = AnnualCroppingFactory.create(activity=a, land_use_change=luc)
set_aside: SetAside = SetAsideFactory.create(activity=a, land_use_change=luc)
