...
class GrasslandToSettlement(t.LandUseChangeTest):
    def __init__(self):
        super().__init__()
        ...
        self.module_type_w = ModuleType.objects.get(class_name="Settlement")
        ...
        self.module_end: Settlement = self.create_module(self.module_type_w, land_use_change=self.land_use_change)

    def test(self):
        self.calculate_results()


GrasslandToSettlement().test()
