...
class Project(Historical, DirtyFieldsMixin):
    ...
    owner = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name="projects", verbose_name="owner")
    ...
    cost = models.FloatField(null=True, blank=True, verbose_name="cost")
    funding_agency = models.CharField(max_length=100, null=True, blank=True, verbose_name="funding_agency")
    executing_agency = models.CharField(max_length=100, null=True, blank=True, verbose_name="executing_agency")
    status = models.ForeignKey(ProjectStatus, on_delete=models.CASCADE, null=True, blank=True, verbose_name="status")
    note = GenericRelation("api.Note", related_name="projects")

    implementation_years = models.IntegerField(verbose_name="implementation_years")
    ...
    gwp_co2_t2 = models.FloatField(null=True, blank=True, verbose_name="gwp_co2_t2")
    gwp_ch4_t2 = models.FloatField(null=True, blank=True, verbose_name="gwp_ch4_t2")
    gwp_n2o_t2 = models.FloatField(null=True, blank=True, verbose_name="gwp_n2o_t2")
    gwp_ch4_fossil_t2 = models.FloatField(null=True, blank=True, verbose_name="gwp_ch4_fossil_t2")

    soc_ref_t2 = models.FloatField(null=True, blank=True, verbose_name="soc_ref_t2")
    ...
    is_archived = models.BooleanField(default=False, verbose_name="is_archived")  # TODO: Use this when projects are deleted
...
class Activity(Historical, NoteMixin, DirtyFieldsMixin):
    project = models.ForeignKey(Project, on_delete=models.CASCADE, related_name="activities", verbose_name="project")
    ...
    soil_type_t2 = models.ForeignKey(SoilType, on_delete=models.CASCADE, null=True, blank=True, verbose_name="soil_type_t2")
    duration_t2 = models.IntegerField(null=True, blank=True, verbose_name="duration_t2")
    start_year_t2 = models.IntegerField(null=True, blank=True, verbose_name="start_year_t2")
    last_year_of_accounting_t2 = models.IntegerField(null=True, blank=True, verbose_name="last_year_of_accounting_t2")
    soc_t2 = models.FloatField(null=True, blank=True, verbose_name="soc_t2")
    ...
    @property
    def is_luc(self):
        return any([issubclass(module.__class__, LandModule) for module in self.modules])

    @property
    def is_fishery(self):
        return any([issubclass(module.__class__, Fishery) for module in self.modules])
...
class Submodule(Historical, CachedResultMixin):
    ...
    data_source = models.ForeignKey(DataSource, on_delete=models.CASCADE, null=True, blank=True, verbose_name="data_source")
...
class Module(Historical, CachedResultMixin):
    ...
    activity = models.ForeignKey(Activity, on_delete=models.CASCADE, related_name="%(class)s", verbose_name="activity")
    ...
    status = models.ForeignKey(StatusType, on_delete=models.CASCADE, null=True, blank=True, verbose_name="status")
    data_source = models.ForeignKey(DataSource, on_delete=models.CASCADE, null=True, blank=True, verbose_name="data_source")
...
class BiomassMixin(models.Model):
    biomass_t2_start = models.FloatField(null=True, blank=True, verbose_name="biomass_t2_start")
    biomass_t2_w = models.FloatField(null=True, blank=True, verbose_name="biomass_t2_w")
    biomass_t2_wo = models.FloatField(null=True, blank=True, verbose_name="biomass_t2_wo")
...
class ResidueAvailability(models.Model):
    residue_availability_t2_start = models.FloatField(null=True, blank=True, verbose_name="residue_availability_t2_start")
    residue_availability_t2_w = models.FloatField(null=True, blank=True, verbose_name="residue_availability_t2_w")
    residue_availability_t2_wo = models.FloatField(null=True, blank=True, verbose_name="residue_availability_t2_wo")
...
class AboveBelowGroundBiomassModule(BiomassModule):
    agb_t2_start = models.FloatField(null=True, blank=True, verbose_name="agb_t2_start")
...
class LitterDeadwoodBiomassModule(AboveBelowGroundBiomassModule):
    litter_t2_start = models.FloatField(null=True, blank=True, verbose_name="litter_t2_start")
    litter_t2_w = models.FloatField(null=True, blank=True, verbose_name="litter_t2_w")
    litter_t2_wo = models.FloatField(null=True, blank=True, verbose_name="litter_t2_wo")

    deadwood_t2_start = models.FloatField(null=True, blank=True, verbose_name="deadwood_t2_start")
    deadwood_t2_w = models.FloatField(null=True, blank=True, verbose_name="deadwood_t2_w")
    deadwood_t2_wo = models.FloatField(null=True, blank=True, verbose_name="deadwood_t2_wo")
...
class LandModule(Module):
    land_use_change = models.OneToOneField("api.LandUseChange", on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s", verbose_name="land_use_change")
    organic_soil = models.OneToOneField("api.OrganicSoil", on_delete=models.CASCADE, null=True, blank=True, related_name="organic_soil_%(class)s", verbose_name="organic_soil")

    area = models.FloatField(null=True, blank=True, validators=[validators.MinValueValidator(0)], verbose_name="area")

    land_use_type_start = models.ForeignKey(LandUseType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_land_use_type_start", verbose_name="land_use_type_start")
    land_use_type_w = models.ForeignKey(LandUseType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_land_use_type_w", verbose_name="land_use_type_w")
    land_use_type_wo = models.ForeignKey(LandUseType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_land_use_type_wo", verbose_name="land_use_type_wo")
    ...
    flu_t2_start = models.FloatField(null=True, blank=True, verbose_name="flu_t2_start")
    flu_t2_w = models.FloatField(null=True, blank=True, verbose_name="flu_t2_w")
    flu_t2_wo = models.FloatField(null=True, blank=True, verbose_name="flu_t2_wo")

    fi_t2_start = models.FloatField(null=True, blank=True, verbose_name="fi_t2_start")
    fi_t2_w = models.FloatField(null=True, blank=True, verbose_name="fi_t2_w")
    fi_t2_wo = models.FloatField(null=True, blank=True, verbose_name="fi_t2_wo")

    fmg_t2_start = models.FloatField(null=True, blank=True, verbose_name="fmg_t2_start")
    fmg_t2_w = models.FloatField(null=True, blank=True, verbose_name="fmg_t2_w")
    fmg_t2_wo = models.FloatField(null=True, blank=True, verbose_name="fmg_t2_wo")
...
class AnnualCropland(LandModule, SingleBiomassModule, ResidueAvailability):
    tillage_management_type_start = models.ForeignKey(TillageManagementType, on_delete=models.CASCADE, related_name="%(class)s_tillage_management_type_start", null=True, blank=True, verbose_name="tillage_management_type_start")
    tillage_management_type_w = models.ForeignKey(TillageManagementType, on_delete=models.CASCADE, related_name="%(class)s_tillage_management_type_w", null=True, blank=True, verbose_name="tillage_management_type_w")
    tillage_management_type_wo = models.ForeignKey(TillageManagementType, on_delete=models.CASCADE, related_name="%(class)s_tillage_management_type_wo", null=True, blank=True, verbose_name="tillage_management_type_wo")
    ...
    organic_input_type_start = models.ForeignKey(OrganicInputType, on_delete=models.CASCADE, related_name="%(class)s_organic_input_type_start", null=True, blank=True, verbose_name="organic_input_type_start")
    organic_input_type_w = models.ForeignKey(OrganicInputType, on_delete=models.CASCADE, related_name="%(class)s_organic_input_type_w", null=True, blank=True, verbose_name="organic_input_type_w")
    organic_input_type_wo = models.ForeignKey(OrganicInputType, on_delete=models.CASCADE, related_name="%(class)s_organic_input_type_wo", null=True, blank=True, verbose_name="organic_input_type_wo")
    ...
    residue_management_type_start = models.ForeignKey(ResidueManagementType, on_delete=models.CASCADE, related_name="%(class)s_residue_management_type_start", null=True, blank=True, verbose_name="residue_management_type_start")
    residue_management_type_w = models.ForeignKey(ResidueManagementType, on_delete=models.CASCADE, related_name="%(class)s_residue_management_type_w", null=True, blank=True, verbose_name="residue_management_type_w")
    residue_management_type_wo = models.ForeignKey(ResidueManagementType, on_delete=models.CASCADE, related_name="%(class)s_residue_management_type_wo", null=True, blank=True, verbose_name="residue_management_type_wo")
    ...
    crop_yield_t2_start = models.FloatField(null=True, blank=True, verbose_name="crop_yield_t2_start")
    ...
    minor_land_use_type_start = models.ForeignKey(LandUseType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_minor_land_use_type_start", verbose_name="minor_land_use_type_start")
    minor_land_use_type_w = models.ForeignKey(LandUseType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_minor_land_use_type_w", verbose_name="minor_land_use_type_w")
    minor_land_use_type_wo = models.ForeignKey(LandUseType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_minor_land_use_type_wo", verbose_name="minor_land_use_type_wo")

    minor_yield_start = models.FloatField(null=True, blank=True, verbose_name="minor_yield_start")
    minor_yield_w = models.FloatField(null=True, blank=True, verbose_name="minor_yield_w")
    minor_yield_wo = models.FloatField(null=True, blank=True, verbose_name="minor_yield_wo")

    minor_residue_management_type_start = models.ForeignKey(ResidueManagementType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_minor_residue_management_type", verbose_name="minor_residue_management_type_start")
    minor_residue_management_type_w = models.ForeignKey(ResidueManagementType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_minor_residue_management_type_w", verbose_name="minor_residue_management_type_w")
    minor_residue_management_type_wo = models.ForeignKey(ResidueManagementType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_minor_residue_management_type_wo", verbose_name="minor_residue_management_type_wo")

    minor_biomass_factor_t2_start = models.FloatField(null=True, blank=True, verbose_name="minor_biomass_factor_t2_start")
    minor_biomass_factor_t2_w = models.FloatField(null=True, blank=True, verbose_name="minor_biomass_factor_t2_w")
    minor_biomass_factor_t2_wo = models.FloatField(null=True, blank=True, verbose_name="minor_biomass_factor_t2_wo")
...
class PerennialCrop(models.Model):
    ...
    tillage_management_type_wo = models.ForeignKey(TillageManagementType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_tillage_management_type_wo", verbose_name="tillage_management_type_wo")
    tillage_management_type_thread = models.ForeignKey(CommentThread, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_tillage_management_type_thread")

    organic_input_type_start = models.ForeignKey(OrganicInputType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_organic_input_type_start", verbose_name="organic_input_type_start")
    organic_input_type_w = models.ForeignKey(OrganicInputType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_organic_input_type_w", verbose_name="organic_input_type_w")
    organic_input_type_wo = models.ForeignKey(OrganicInputType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_organic_input_type_wo", verbose_name="organic_input_type_wo")
    organic_input_type_thread = models.ForeignKey(CommentThread, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_organic_input_type_thread")

    is_biomass_burned_start = models.BooleanField(null=True, blank=True, verbose_name="is_biomass_burned_start")
    is_biomass_burned_w = models.BooleanField(null=True, blank=True, verbose_name="is_biomass_burned_w")
    is_biomass_burned_wo = models.BooleanField(null=True, blank=True, verbose_name="is_biomass_burned_wo")
    ...
    agb_max_t2_start = models.FloatField(null=True, blank=True, verbose_name="agb_max_t2_start")
    agb_max_t2_w = models.FloatField(null=True, blank=True, verbose_name="agb_max_t2_w")
    agb_max_t2_wo = models.FloatField(null=True, blank=True, verbose_name="agb_max_t2_wo")

    fire_periodicity_t2_start = models.FloatField(null=True, blank=True, verbose_name="fire_periodicity_t2_start")
    fire_periodicity_t2_w = models.FloatField(null=True, blank=True, verbose_name="fire_periodicity_t2_w")
...
class CroplandMinorSeason(models.Model):
    ...
    residue_management_type_start = models.ForeignKey(ResidueManagementType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_residue_management_type_start", verbose_name="residue_management_type_start")
    residue_management_type_w = models.ForeignKey(ResidueManagementType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_residue_management_type_w", verbose_name="residue_management_type_w")
    residue_management_type_wo = models.ForeignKey(ResidueManagementType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_residue_management_type_wo", verbose_name="residue_management_type_wo")
    residue_management_type_thread = models.ForeignKey(CommentThread, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_residue_management_type_thread")
...
class Rice(ResidueAvailability):
    ...
    water_management_type_before_cultivation_start = models.ForeignKey(
        WaterManagementTypeBeforeCultivation,
        on_delete=models.CASCADE,
        related_name="%(class)s_water_management_type_before_cultivation_start",
        null=True,
        verbose_name="water_management_type_before_cultivation_start",
    )
    water_management_type_before_cultivation_w = models.ForeignKey(
        WaterManagementTypeBeforeCultivation,
        on_delete=models.CASCADE,
        related_name="%(class)s_water_management_type_before_cultivation_w",
        null=True,
        verbose_name="water_management_type_before_cultivation_w",
    )
    water_management_type_before_cultivation_wo = models.ForeignKey(
        WaterManagementTypeBeforeCultivation,
        on_delete=models.CASCADE,
        related_name="%(class)s_water_management_type_before_cultivation_wo",
        null=True,
        verbose_name="water_management_type_before_cultivation_wo",
    )

    water_management_type_after_cultivation_start = models.ForeignKey(
        WaterManagementTypeAfterCultivation,
        on_delete=models.CASCADE,
        related_name="%(class)s_water_management_type_after_cultivation_start",
        null=True,
        verbose_name="water_management_type_after_cultivation_start",
    )
    water_management_type_after_cultivation_w = models.ForeignKey(
        WaterManagementTypeAfterCultivation,
        on_delete=models.CASCADE,
        related_name="%(class)s_water_management_type_after_cultivation_w",
        null=True,
        verbose_name="water_management_type_after_cultivation_w",
    )
    water_management_type_after_cultivation_wo = models.ForeignKey(
        WaterManagementTypeAfterCultivation,
        on_delete=models.CASCADE,
        related_name="%(class)s_water_management_type_after_cultivation_wo",
        null=True,
        verbose_name="water_management_type_after_cultivation_wo",
    )
    ...
    efc_t2_start = models.FloatField(null=True, blank=True, verbose_name="efc_t2_start")
    efc_t2_w = models.FloatField(null=True, blank=True, verbose_name="efc_t2_w")
    efc_t2_wo = models.FloatField(null=True, blank=True, verbose_name="efc_t2_wo")

    sfw_t2_start = models.FloatField(null=True, blank=True, verbose_name="sfw_t2_start")
    sfw_t2_w = models.FloatField(null=True, blank=True, verbose_name="sfw_t2_w")
    sfw_t2_wo = models.FloatField(null=True, blank=True, verbose_name="sfw_t2_wo")

    sfp_t2_start = models.FloatField(null=True, blank=True, verbose_name="sfp_t2_start")
    sfp_t2_w = models.FloatField(null=True, blank=True, verbose_name="sfp_t2_w")
    sfp_t2_wo = models.FloatField(null=True, blank=True, verbose_name="sfp_t2_wo")

    sfo_t2_start = models.FloatField(null=True, blank=True, verbose_name="sfo_t2_start")
    sfo_t2_w = models.FloatField(null=True, blank=True, verbose_name="sfo_t2_w")
    sfo_t2_wo = models.FloatField(null=True, blank=True, verbose_name="sfo_t2_wo")

    efi_t2_start = models.FloatField(null=True, blank=True, verbose_name="efi_t2_start")
    efi_t2_w = models.FloatField(null=True, blank=True, verbose_name="efi_t2_w")
    efi_t2_wo = models.FloatField(null=True, blank=True, verbose_name="efi_t2_wo")

    rice_straw_t2_start = models.FloatField(null=True, blank=True, verbose_name="rice_straw_t2_start")
    rice_straw_t2_w = models.FloatField(null=True, blank=True, verbose_name="rice_straw_t2_w")
    rice_straw_t2_wo = models.FloatField(null=True, blank=True, verbose_name="rice_straw_t2_wo")

    cultivation_period_t2_start = models.IntegerField(null=True, blank=True, verbose_name="cultivation_period_t2_start")
    cultivation_period_t2_w = models.IntegerField(null=True, blank=True, verbose_name="cultivation_period_t2_w")
    cultivation_period_t2_wo = models.IntegerField(null=True, blank=True, verbose_name="cultivation_period_t2_wo")
...
class Grassland(LandModuleFixed, SingleBiomassModule, AboveBelowGroundBiomassModule):
    ...
    is_fire_used_start = models.BooleanField(default=False, verbose_name="is_fire_used_start")
    is_fire_used_w = models.BooleanField(default=False, verbose_name="is_fire_used_w")
    is_fire_used_wo = models.BooleanField(default=False, verbose_name="is_fire_used_wo")
    ...
    fire_periodicity_start = models.FloatField(null=True, blank=True, default=0, verbose_name="fire_periodicity_start")
    fire_periodicity_w = models.FloatField(null=True, blank=True, default=0, verbose_name="fire_periodicity_w")
    fire_periodicity_wo = models.FloatField(null=True, blank=True, default=0, verbose_name="fire_periodicity_wo")
    ...
    fire_impact_start = models.FloatField(null=True, blank=True, default=0, verbose_name="fire_impact_start")
    fire_impact_w = models.FloatField(null=True, blank=True, default=0, verbose_name="fire_impact_w")
    fire_impact_wo = models.FloatField(null=True, blank=True, default=0, verbose_name="fire_impact_wo")
    ...
    yield_start = models.FloatField(null=True, blank=True, verbose_name="yield_start")
    yield_w = models.FloatField(null=True, blank=True, verbose_name="yield_w")
    yield_wo = models.FloatField(null=True, blank=True, verbose_name="yield_wo")
    ...
    combustion_factor_t2_start = models.FloatField(null=True, blank=True, verbose_name="combustion_factor_t2_start")
    combustion_factor_t2_w = models.FloatField(null=True, blank=True, verbose_name="combustion_factor_t2_w")
    combustion_factor_t2_wo = models.FloatField(null=True, blank=True, verbose_name="combustion_factor_t2_wo")
...
class Livestock(Module):
    livestock_category_type = models.ForeignKey(LivestockCategoryType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_livestock_category_type", verbose_name="livestock_category_type")
    ...
    livestock_production_type_start = models.ForeignKey(LivestockProductionType, on_delete=models.CASCADE, null=True, blank=True, verbose_name="livestock_production_type_start")
    livestock_production_type_w = models.ForeignKey(LivestockProductionType, on_delete=models.CASCADE, related_name="%(class)s_livestock_productions_w", null=True, blank=True, verbose_name="livestock_production_type_w")
    livestock_production_type_wo = models.ForeignKey(LivestockProductionType, on_delete=models.CASCADE, related_name="%(class)s_livestock_productions_wo", null=True, blank=True, verbose_name="livestock_production_type_wo")
    ...
    production_start = models.FloatField(null=True, blank=True, verbose_name="production_start")
    production_w = models.FloatField(null=True, blank=True, verbose_name="production_w")
    production_wo = models.FloatField(null=True, blank=True, verbose_name="production_wo")
    ...
    heads_number_start = models.IntegerField(null=True, blank=True, verbose_name="heads_number_start")
    heads_number_w = models.IntegerField(null=True, blank=True, verbose_name="heads_number_w")
    heads_number_wo = models.IntegerField(null=True, blank=True, verbose_name="heads_number_wo")
    ...
    complementary_manure_management_type_start = models.ForeignKey(ManureManagementType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_manure_management_type_t2_start", verbose_name="complementary_manure_management_type_start")
    complementary_manure_management_type_w = models.ForeignKey(ManureManagementType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_manure_management_type_t2_w", verbose_name="complementary_manure_management_type_w")
    complementary_manure_management_type_wo = models.ForeignKey(ManureManagementType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_manure_management_type_t2_wo", verbose_name="complementary_manure_management_type_wo")
    complementary_manure_management_type_thread = models.OneToOneField(CommentThread, null=True, blank=True, related_name="%(class)s_complementary_manure_management_type_thread", on_delete=models.SET_NULL)

    enteric_fermentation_t2_start = models.FloatField(null=True, blank=True, verbose_name="enteric_fermentation_t2_start")
    enteric_fermentation_t2_w = models.FloatField(null=True, blank=True, verbose_name="enteric_fermentation_t2_w")
    enteric_fermentation_t2_wo = models.FloatField(null=True, blank=True, verbose_name="enteric_fermentation_t2_wo")

    prp_percentage_t2_start = models.FloatField(null=True, blank=True, verbose_name="prp_percentage_t2_start")
    prp_percentage_t2_w = models.FloatField(null=True, blank=True, verbose_name="prp_percentage_t2_w")
    prp_percentage_t2_wo = models.FloatField(null=True, blank=True, verbose_name="prp_percentage_t2_wo")
    ...
    prp_ch4_t2_start = models.FloatField(null=True, blank=True, verbose_name="prp_ch4_t2_start")
    prp_ch4_t2_w = models.FloatField(null=True, blank=True, verbose_name="prp_ch4_t2_w")
    prp_ch4_t2_wo = models.FloatField(null=True, blank=True, verbose_name="prp_ch4_t2_wo")

    prp_n2o_t2_start = models.FloatField(null=True, blank=True, verbose_name="prp_n2o_t2_start")
    prp_n2o_t2_w = models.FloatField(null=True, blank=True, verbose_name="prp_n2o_t2_w")
    prp_n2o_t2_wo = models.FloatField(null=True, blank=True, verbose_name="prp_n2o_t2_wo")

    emission_factor_ch4_t2_start = models.FloatField(null=True, blank=True, verbose_name="emission_factor_ch4_t2_start")
    emission_factor_n2o_t2_start = models.FloatField(null=True, blank=True, verbose_name="emission_factor_n2o_t2_start")

    emission_factor_ch4_t2_w = models.FloatField(null=True, blank=True, verbose_name="emission_factor_ch4_t2_w")
    emission_factor_n2o_t2_w = models.FloatField(null=True, blank=True, verbose_name="emission_factor_n2o_t2_w")

    emission_factor_ch4_t2_wo = models.FloatField(null=True, blank=True, verbose_name="emission_factor_ch4_t2_wo")
    emission_factor_n2o_t2_wo = models.FloatField(null=True, blank=True, verbose_name="emission_factor_n2o_t2_wo")

    implementation_year_start = models.IntegerField(null=True, blank=True, verbose_name="implementation_year_start")
...
class ForestManagement(LandModule, LitterDeadwoodBiomassModule):
    forest_type = models.ForeignKey(ForestType, on_delete=models.CASCADE, null=True, blank=True, verbose_name="forest_type")
    forest_condition_type = models.ForeignKey(ForestConditionType, on_delete=models.CASCADE, null=True, blank=True, verbose_name="forest_condition_type")

    ##### ROTATION #####

    rotation_length_yrs_start = models.IntegerField(null=True, blank=True, verbose_name="rotation_length_yrs_start")
    rotation_length_yrs_w = models.IntegerField(null=True, blank=True, verbose_name="rotation_length_yrs_w")
    rotation_length_yrs_wo = models.IntegerField(null=True, blank=True, verbose_name="rotation_length_yrs_wo")
    ...
    rotation_percentage_biomass_for_energy_start = models.FloatField(null=True, blank=True, default=0, verbose_name="rotation_percentage_biomass_for_energy_start")
    rotation_percentage_biomass_for_energy_w = models.FloatField(null=True, blank=True, default=0, verbose_name="rotation_percentage_biomass_for_energy_w")
    rotation_percentage_biomass_for_energy_wo = models.FloatField(null=True, blank=True, default=0, verbose_name="rotation_percentage_biomass_for_energy_wo")
    ...
    logging_recurrence_yrs_start = models.IntegerField(null=True, blank=True, verbose_name="logging_recurrence_yrs_start")
    logging_recurrence_yrs_w = models.IntegerField(null=True, blank=True, verbose_name="logging_recurrence_yrs_w")
    logging_recurrence_yrs_wo = models.IntegerField(null=True, blank=True, verbose_name="logging_recurrence_yrs_wo")
    ...
    logging_percentage_agb_logged_start = models.FloatField(null=True, blank=True, default=0, validators=[validators.MinValueValidator(0), validators.MaxValueValidator(1)], verbose_name="logging_percentage_agb_logged_start")
    logging_percentage_agb_logged_w = models.FloatField(null=True, blank=True, default=0, validators=[validators.MinValueValidator(0), validators.MaxValueValidator(1)], verbose_name="logging_percentage_agb_logged_w")
    logging_percentage_agb_logged_wo = models.FloatField(null=True, blank=True, default=0, validators=[validators.MinValueValidator(0), validators.MaxValueValidator(1)], verbose_name="logging_percentage_agb_logged_wo")
    ...
    logging_percentage_biomass_for_energy_start = models.FloatField(null=True, blank=True, default=0, verbose_name="logging_percentage_biomass_for_energy_start")
    logging_percentage_biomass_for_energy_w = models.FloatField(null=True, blank=True, default=0, verbose_name="logging_percentage_biomass_for_energy_w")
    logging_percentage_biomass_for_energy_wo = models.FloatField(null=True, blank=True, default=0, verbose_name="logging_percentage_biomass_for_energy_wo")
    ...
    average_yearly_degradation_percentage_start = models.FloatField(null=True, blank=True, default=0, verbose_name="average_yearly_degradation_percentage_start")
    average_yearly_degradation_percentage_w = models.FloatField(null=True, blank=True, default=0, verbose_name="average_yearly_degradation_percentage_w")
    average_yearly_degradation_percentage_wo = models.FloatField(null=True, blank=True, default=0, verbose_name="average_yearly_degradation_percentage_wo")
...
class ForestDisturbance(Submodule):
    ...
    disturbance_type = models.ForeignKey(DisturbanceType, on_delete=models.CASCADE, null=True, blank=True, verbose_name="disturbance_type")
    ...
    recurrence_yrs_start = models.IntegerField(null=True, blank=True, verbose_name="recurrence_yrs_start")
    recurrence_yrs_w = models.IntegerField(null=True, blank=True, verbose_name="recurrence_yrs_w")
    recurrence_yrs_wo = models.IntegerField(null=True, blank=True, verbose_name="recurrence_yrs_wo")
    ...
    percentage_biomass_destruction_start = models.FloatField(null=True, blank=True, verbose_name="percentage_biomass_destruction_start")
    percentage_biomass_destruction_w = models.FloatField(null=True, blank=True, verbose_name="percentage_biomass_destruction_w")
    percentage_biomass_destruction_wo = models.FloatField(null=True, blank=True, verbose_name="percentage_biomass_destruction_wo")
    ...
    start_year_t2_start = models.IntegerField(default=1, verbose_name="start_year_t2_start")
    start_year_t2_w = models.IntegerField(default=1, verbose_name="start_year_t2_w")
    start_year_t2_wo = models.IntegerField(default=1, verbose_name="start_year_t2_wo")

    dry_matter_impacted_t2_start = models.FloatField(null=True, blank=True, verbose_name="dry_matter_impacted_t2_start")
    dry_matter_impacted_t2_w = models.FloatField(null=True, blank=True, verbose_name="dry_matter_impacted_t2_w")
    dry_matter_impacted_t2_wo = models.FloatField(null=True, blank=True, verbose_name="dry_matter_impacted_t2_wo")
...
class Waterbody(Module):
    waterbody_type = models.ForeignKey(WaterbodyType, on_delete=models.CASCADE, null=True, blank=True, verbose_name="waterbody_type")
    area = models.FloatField(null=True, blank=True, verbose_name="area")
    trophic_type_start = models.ForeignKey(TrophicType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_trophic_class_start", verbose_name="trophic_type_start")
    trophic_type_w = models.ForeignKey(TrophicType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_trophic_class_w", verbose_name="trophic_type_w")
    trophic_type_wo = models.ForeignKey(TrophicType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_trophic_class_wo", verbose_name="trophic_type_wo")
    ...
    ch4_ef_t2_start = models.FloatField(null=True, blank=True, verbose_name="ch4_ef_t2_start")
    ch4_ef_t2_w = models.FloatField(null=True, blank=True, verbose_name="ch4_ef_t2_w")
    ch4_ef_t2_wo = models.FloatField(null=True, blank=True, verbose_name="ch4_ef_t2_wo")

    alpha_t2_start = models.FloatField(null=True, blank=True, verbose_name="alpha_t2_start")
    alpha_t2_w = models.FloatField(null=True, blank=True, verbose_name="alpha_t2_w")
    alpha_t2_wo = models.FloatField(null=True, blank=True, verbose_name="alpha_t2_wo")

    mean_annual_t2_start = models.FloatField(null=True, blank=True, verbose_name="mean_annual_t2_start")
    mean_annual_t2_w = models.FloatField(null=True, blank=True, verbose_name="mean_annual_t2_w")
    mean_annual_t2_wo = models.FloatField(null=True, blank=True, verbose_name="mean_annual_t2_wo")


class CoastalWetland(Module):
    land_use_type = models.ForeignKey(LandUseType, on_delete=models.CASCADE, null=True, blank=True, verbose_name="land_use_type")
    ...
    pc_c_lost_after_excavation_t2_start = models.FloatField(null=True, blank=True, verbose_name="pc_c_lost_after_excavation_t2_start")
    pc_c_lost_after_excavation_t2_w = models.FloatField(null=True, blank=True, verbose_name="pc_c_lost_after_excavation_t2_w")
    pc_c_lost_after_excavation_t2_wo = models.FloatField(null=True, blank=True, verbose_name="pc_c_lost_after_excavation_t2_wo")
    ...
    drainage_ef_t2_start = models.FloatField(null=True, blank=True, verbose_name="drainage_ef_t2_start")
    drainage_ef_t2_w = models.FloatField(null=True, blank=True, verbose_name="drainage_ef_t2_w")
    drainage_ef_t2_wo = models.FloatField(null=True, blank=True, verbose_name="drainage_ef_t2_wo")

    co2_rewetting_t2_start = models.FloatField(null=True, blank=True, verbose_name="co2_rewetting_t2_start")
    co2_rewetting_t2_w = models.FloatField(null=True, blank=True, verbose_name="co2_rewetting_t2_w")
    co2_rewetting_t2_wo = models.FloatField(null=True, blank=True, verbose_name="co2_rewetting_t2_wo")

    ch4_rewetting_t2_start = models.FloatField(null=True, blank=True, verbose_name="ch4_rewetting_t2_start")
    ch4_rewetting_t2_w = models.FloatField(null=True, blank=True, verbose_name="ch4_rewetting_t2_w")
    ch4_rewetting_t2_wo = models.FloatField(null=True, blank=True, verbose_name="ch4_rewetting_t2_wo")

    avg_salinity_t2 = models.ForeignKey(SalinityType, null=True, blank=True, on_delete=models.SET_NULL, verbose_name="avg_salinity_t2")
...
class Fishery(Module):
    ...
    energy_ef_co2_t2_wo = models.FloatField(null=True, blank=True, verbose_name="energy_emission_factor_co2_t2_wo")

    energy_ef_ch4_t2_start = models.FloatField(null=True, blank=True, verbose_name="energy_emission_factor_ch4_t2_start")
    energy_ef_ch4_t2_w = models.FloatField(null=True, blank=True, verbose_name="energy_emission_factor_ch4_t2_w")
    energy_ef_ch4_t2_wo = models.FloatField(null=True, blank=True, verbose_name="energy_emission_factor_ch4_t2_wo")

    energy_ef_n2o_t2_start = models.FloatField(null=True, blank=True, verbose_name="energy_emission_factor_n2o_t2_start")
    energy_ef_n2o_t2_w = models.FloatField(null=True, blank=True, verbose_name="energy_emission_factor_n2o_t2_w")
    energy_ef_n2o_t2_wo = models.FloatField(null=True, blank=True, verbose_name="energy_emission_factor_n2o_t2_wo")

    refrigerant_lost_per_tonne_t2_start = models.FloatField(null=True, blank=True, verbose_name="refrigerant_lost_per_tonne_t2_start")
    refrigerant_lost_per_tonne_t2_w = models.FloatField(null=True, blank=True, verbose_name="refrigerant_lost_per_tonne_t2_w")
    refrigerant_lost_per_tonne_t2_wo = models.FloatField(null=True, blank=True, verbose_name="refrigerant_lost_per_tonne_t2_wo")

    refrigerant_gwp_t2_start = models.FloatField(null=True, blank=True, verbose_name="refrigerant_gwp_t2_start")
    refrigerant_gwp_t2_w = models.FloatField(null=True, blank=True, verbose_name="refrigerant_gwp_t2_w")
    refrigerant_gwp_t2_wo = models.FloatField(null=True, blank=True, verbose_name="refrigerant_gwp_t2_wo")

    tonnes_of_ice_t2_start = models.FloatField(null=True, blank=True, verbose_name="tonnes_of_ice_t2_start")
    tonnes_of_ice_t2_w = models.FloatField(null=True, blank=True, verbose_name="tonnes_of_ice_t2_w")
    tonnes_of_ice_t2_wo = models.FloatField(null=True, blank=True, verbose_name="tonnes_of_ice_t2_wo")

    inshore_ice_production_kwh_per_tonne_t2_start = models.FloatField(null=True, blank=True, verbose_name="inshore_ice_production_kwh_per_tonne_t2_start")
    inshore_ice_production_kwh_per_tonne_t2_w = models.FloatField(null=True, blank=True, verbose_name="inshore_ice_production_kwh_per_tonne_t2_w")
    inshore_ice_production_kwh_per_tonne_t2_wo = models.FloatField(null=True, blank=True, verbose_name="inshore_ice_production_kwh_per_tonne_t2_wo")

    fui_t2_start = models.FloatField(null=True, blank=True, verbose_name="fui_t2_start")
...
class SmallFishery(Fishery):
    gear_type_start = models.ForeignKey(SmallFisheryGearType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_gear_type_start", verbose_name="gear_type_start")
    gear_type_w = models.ForeignKey(SmallFisheryGearType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_gear_type_w", verbose_name="gear_type_w")
    gear_type_wo = models.ForeignKey(SmallFisheryGearType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_gear_type_wo", verbose_name="gear_type_wo")
    ...
    fishery_type = models.ForeignKey(FisheryType, on_delete=models.CASCADE, null=True, blank=True, verbose_name="fishery_type")


class LargeFishery(Fishery):
    gear_type_start = models.ForeignKey(LargeFisheryGearType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_gear_type_start", verbose_name="gear_type_start")
    gear_type_w = models.ForeignKey(LargeFisheryGearType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_gear_type_w", verbose_name="gear_type_w")
    gear_type_wo = models.ForeignKey(LargeFisheryGearType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_gear_type_wo", verbose_name="gear_type_wo")
    gear_type_thread = models.OneToOneField(CommentThread, null=True, blank=True, related_name="%(class)s_gear_type_thread", on_delete=models.SET_NULL)
    fish_type = models.ForeignKey(FishType, on_delete=models.CASCADE, null=True, blank=True, verbose_name="fish_type")


class Aquaculture(Module):
    annual_production_start = models.FloatField(null=True, blank=True, verbose_name="annual_production_start")
    annual_production_w = models.FloatField(null=True, blank=True, verbose_name="annual_production_w")
    annual_production_wo = models.FloatField(null=True, blank=True, verbose_name="annual_production_wo")
    ...
    n2o_from_production_t2_start = models.FloatField(null=True, blank=True, verbose_name="n2o_from_production_t2_start")
    n2o_from_production_t2_w = models.FloatField(null=True, blank=True, verbose_name="n2o_from_production_t2_w")
    n2o_from_production_t2_wo = models.FloatField(null=True, blank=True, verbose_name="n2o_from_production_t2_wo")

    electricity_used_t2_start = models.FloatField(null=True, blank=True, verbose_name="electricity_used_t2_start")
    electricity_used_t2_w = models.FloatField(null=True, blank=True, verbose_name="electricity_used_t2_w")
    electricity_used_t2_wo = models.FloatField(null=True, blank=True, verbose_name="electricity_used_t2_wo")

    electricity_ef_t2_start = models.FloatField(null=True, blank=True, verbose_name="electricity_ef_t2_start")  # TODO: Rename to n2o_fish_production
    electricity_ef_t2_w = models.FloatField(null=True, blank=True, verbose_name="electricity_ef_t2_w")
    electricity_ef_t2_wo = models.FloatField(null=True, blank=True, verbose_name="electricity_ef_t2_wo")
...
class InputEntry(Submodule):
    ...
    input_type = models.ForeignKey(InputType, null=True, blank=True, on_delete=models.CASCADE, verbose_name="input_type")

    value_start = models.FloatField(null=True, blank=True, verbose_name="value_start")
    value_w = models.FloatField(null=True, blank=True, verbose_name="value_w")
    value_wo = models.FloatField(null=True, blank=True, verbose_name="value_wo")
    ...
    co2_emissions_t2 = models.FloatField(null=True, blank=True, verbose_name="co2_emissions_t2")
    n2o_emissions_t2 = models.FloatField(null=True, blank=True, verbose_name="n2o_emissions_t2")
    co2_e_emissions_t2 = models.FloatField(null=True, blank=True, verbose_name="co2_e_emissions_t2")
...
class ElectricityTier2Mixin(models.Model):
    ...
    electricity_ef_t2_start = models.FloatField(null=True, blank=True, verbose_name="ef_t2_start")
    electricity_ef_t2_w = models.FloatField(null=True, blank=True, verbose_name="ef_t2_w")
    electricity_ef_t2_wo = models.FloatField(null=True, blank=True, verbose_name="ef_t2_wo")
    ...
    ef_source = models.ForeignKey(EmissionFactorSource, on_delete=models.CASCADE, null=True, blank=True, verbose_name="ef_source")
...
class ElectricityMixin(models.Model):
    quantity_consumed_per_year_start = models.FloatField(null=True, blank=True, verbose_name="quantity_consumed_per_year_start")
    quantity_consumed_per_year_w = models.FloatField(null=True, blank=True, verbose_name="quantity_consumed_per_year_w")
    quantity_consumed_per_year_wo = models.FloatField(null=True, blank=True, verbose_name="quantity_consumed_per_year_wo")
    ...
    mwh_renewables_start = models.FloatField(null=True, blank=True, verbose_name="mwh_renewables_start")
    mwh_renewables_w = models.FloatField(null=True, blank=True, verbose_name="mwh_renewables_w")
    mwh_renewables_wo = models.FloatField(null=True, blank=True, verbose_name="mwh_renewables_wo")
...
class FuelTier2Mixin(models.Model):
    energy_ef_co2_t2_start = models.FloatField(null=True, blank=True, verbose_name="ef_co2_t2")
    energy_ef_ch4_t2_start = models.FloatField(null=True, blank=True, verbose_name="ef_ch4_t2")
    energy_ef_n2o_t2_start = models.FloatField(null=True, blank=True, verbose_name="ef_n2o_t2")

    energy_ef_co2_t2_w = models.FloatField(null=True, blank=True, verbose_name="ef_co2_t2_w")
    energy_ef_ch4_t2_w = models.FloatField(null=True, blank=True, verbose_name="ef_ch4_t2_w")
    energy_ef_n2o_t2_w = models.FloatField(null=True, blank=True, verbose_name="ef_n2o_t2_w")

    energy_ef_co2_t2_wo = models.FloatField(null=True, blank=True, verbose_name="ef_co2_t2_wo")
    energy_ef_ch4_t2_wo = models.FloatField(null=True, blank=True, verbose_name="ef_ch4_t2_wo")
    energy_ef_n2o_t2_wo = models.FloatField(null=True, blank=True, verbose_name="ef_n2o_t2_wo")
...
class FuelMixin(models.Model):
    fuel_type_start = models.ForeignKey(FuelType, on_delete=models.CASCADE, null=True, blank=True, verbose_name="fuel_type_start", related_name="%(class)s_fuel_type_start")
    fuel_type_w = models.ForeignKey(FuelType, on_delete=models.CASCADE, null=True, blank=True, verbose_name="fuel_type_w", related_name="%(class)s_fuel_type_w")
    fuel_type_wo = models.ForeignKey(FuelType, on_delete=models.CASCADE, null=True, blank=True, verbose_name="fuel_type_wo", related_name="%(class)s_fuel_type_wo")
...
class IrrigationSystem(Submodule):
    ...
    irrigation_system_type = models.ForeignKey(IrrigationSystemType, on_delete=models.CASCADE, null=True, blank=True, related_name="irrigation_systems", verbose_name="irrigation_system_type")

    ha_start = models.FloatField(null=True, blank=True, verbose_name="ha_start")
    ha_w = models.FloatField(null=True, blank=True, verbose_name="ha_w")
    ha_wo = models.FloatField(null=True, blank=True, verbose_name="ha_wo")
    ha_thread = models.ForeignKey(CommentThread, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_ha_thread")

    ef_t2_start = models.FloatField(null=True, blank=True, verbose_name="ef_t2_start")
    ef_t2_w = models.FloatField(null=True, blank=True, verbose_name="ef_t2_w")
    ef_t2_wo = models.FloatField(null=True, blank=True, verbose_name="ef_t2_wo")
...
class IrrigationPhase(Submodule, ElectricityTier2Mixin, FuelTier2Mixin):
    ...
    irrigation_system_type = models.ForeignKey(IrrigationSystemType, on_delete=models.CASCADE, null=True, blank=True, related_name="irrigation_phases", verbose_name="irrigation_system_type")
    ...
    well_depth = models.FloatField(null=True, blank=True, verbose_name="well_depth")
    ...
    gross_irrigation_water_start = models.FloatField(null=True, blank=True, verbose_name="gross_irrigation_water_start")
    gross_irrigation_water_w = models.FloatField(null=True, blank=True, verbose_name="gross_irrigation_water_w")
    gross_irrigation_water_wo = models.FloatField(null=True, blank=True, verbose_name="gross_irrigation_water_wo")
    ...
    ef_co2_t2_start = models.FloatField(null=True, blank=True, verbose_name="ef_co2_t2_start")
    ef_co2_t2_w = models.FloatField(null=True, blank=True, verbose_name="ef_co2_t2_w")
    ef_co2_t2_wo = models.FloatField(null=True, blank=True, verbose_name="ef_co2_t2_wo")

    ef_ch4_t2_start = models.FloatField(null=True, blank=True, verbose_name="ef_ch4_t2_start")
    ef_ch4_t2_w = models.FloatField(null=True, blank=True, verbose_name="ef_ch4_t2_w")
    ef_ch4_t2_wo = models.FloatField(null=True, blank=True, verbose_name="ef_ch4_t2_wo")

    ef_n2o_t2_start = models.FloatField(null=True, blank=True, verbose_name="ef_n2o_t2_start")
    ef_n2o_t2_w = models.FloatField(null=True, blank=True, verbose_name="ef_n2o_t2_w")
    ef_n2o_t2_wo = models.FloatField(null=True, blank=True, verbose_name="ef_n2o_t2_wo")

    transmission_loss_t2_start = models.FloatField(null=True, blank=True, verbose_name="transmission_loss_t2_start")
    transmission_loss_t2_w = models.FloatField(null=True, blank=True, verbose_name="transmission_loss_t2_w")
    transmission_loss_t2_wo = models.FloatField(null=True, blank=True, verbose_name="transmission_loss_t2_wo")

    average_pressure_t2 = models.FloatField(null=True, blank=True, verbose_name="average_pressure_t2")

    total_dynamic_head_t2 = models.FloatField(null=True, blank=True, verbose_name="total_dynamic_head_t2")

    pumping_efficiency_t2_start = models.FloatField(null=True, blank=True, verbose_name="pumping_efficiency_t2_start")
    pumping_efficiency_t2_w = models.FloatField(null=True, blank=True, verbose_name="pumping_efficiency_t2_w")
    pumping_efficiency_t2_wo = models.FloatField(null=True, blank=True, verbose_name="pumping_efficiency_t2_wo")
...
class Building(Submodule, SettlementSubmoduleTier2Mixin):
    ...
    building_type = models.ForeignKey(BuildingType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_building_type", verbose_name="building_type")
    ...
    area_m2_start = models.FloatField(null=True, blank=True, verbose_name="area_m2_start")
    area_m2_w = models.FloatField(null=True, blank=True, verbose_name="area_m2_w")
    area_m2_wo = models.FloatField(null=True, blank=True, verbose_name="area_m2_wo")
...
class Road(Submodule, SettlementSubmoduleTier2Mixin):
    ...
    road_type = models.ForeignKey(RoadType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_road_type", verbose_name="road_type")
    ...
    length_km_start = models.FloatField(null=True, blank=True, verbose_name="length_km_start")
    length_km_w = models.FloatField(null=True, blank=True, verbose_name="length_km_w")
    length_km_wo = models.FloatField(null=True, blank=True, verbose_name="length_km_wo")
    ...
    width_m_start = models.FloatField(null=True, blank=True, verbose_name="width_m_start")
    width_m_w = models.FloatField(null=True, blank=True, verbose_name="width_m_w")
    width_m_wo = models.FloatField(null=True, blank=True, verbose_name="width_m_wo")
...
class OrganicSoil(LandModuleFixed):
    drainage_area_start = models.FloatField(default=0, verbose_name="drainage_area_start")
    drainage_area_w = models.FloatField(default=0, verbose_name="drainage_area_w")
    drainage_area_wo = models.FloatField(default=0, verbose_name="drainage_area_wo")
    ...
    area_not_drained_start = models.FloatField(default=0, verbose_name="area_not_drained_start")
    area_not_drained_w = models.FloatField(default=0, verbose_name="area_not_drained_w")
    area_not_drained_wo = models.FloatField(default=0, verbose_name="area_not_drained_wo")
    ...
    ditches_area_start = models.FloatField(default=0, verbose_name="ditches_area_start")
    ditches_area_w = models.FloatField(default=0, verbose_name="ditches_area_w")
    ditches_area_wo = models.FloatField(default=0, verbose_name="ditches_area_wo")
    ...
    fire_type_start = models.ForeignKey(FireType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_fire_type_start", verbose_name="fire_type_start")
    fire_type_w = models.ForeignKey(FireType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_fire_type_w", verbose_name="fire_type_w")
    fire_type_wo = models.ForeignKey(FireType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_fire_type_wo", verbose_name="fire_type_wo")
    ...
    soil_fire_periodicity_start = models.FloatField(null=True, blank=True, verbose_name="soil_fire_periodicity_start")
    soil_fire_periodicity_w = models.FloatField(null=True, blank=True, verbose_name="soil_fire_periodicity_w")
    soil_fire_periodicity_wo = models.FloatField(null=True, blank=True, verbose_name="soil_fire_periodicity_wo")
    ...
    soil_fire_impact_percentage_start = models.FloatField(null=True, blank=True, verbose_name="soil_fire_impact_percentage_start")
    soil_fire_impact_percentage_w = models.FloatField(null=True, blank=True, verbose_name="soil_fire_impact_percentage_w")
    ...
    peat_type = models.ForeignKey(PeatType, on_delete=models.CASCADE, null=True, blank=True, default=utils.get_default_peat_type, related_name="%(class)s_peat_type", verbose_name="peat_type")
    ...
    peat_area_start = models.FloatField(null=True, blank=True, verbose_name="peat_area_start")
    peat_area_w = models.FloatField(null=True, blank=True, verbose_name="peat_area_w")
    peat_area_wo = models.FloatField(null=True, blank=True, verbose_name="peat_area_wo")
    ...
    peat_ditches_area_start = models.FloatField(null=True, blank=True, verbose_name="peat_ditches_area_start")
    peat_ditches_area_w = models.FloatField(null=True, blank=True, verbose_name="peat_ditches_area_w")
    peat_ditches_area_wo = models.FloatField(null=True, blank=True, verbose_name="peat_ditches_area_wo")
    ...
    peat_extraction_height_start = models.FloatField(null=True, blank=True, verbose_name="peat_extraction_height_start")
    peat_extraction_height_w = models.FloatField(null=True, blank=True, verbose_name="peat_extraction_height_w")
    peat_extraction_height_wo = models.FloatField(null=True, blank=True, verbose_name="peat_extraction_height_wo")
    ...
    is_peat_for_energy_start = models.BooleanField(default=False, verbose_name="is_peat_for_energy_start")
    is_peat_for_energy_w = models.BooleanField(default=False, verbose_name="is_peat_for_energy_w")
    is_peat_for_energy_wo = models.BooleanField(default=False, verbose_name="is_peat_for_energy_wo")
    ...
    onsite_co2_peat_t2_start = models.FloatField(null=True, blank=True, verbose_name="onsite_co2_peat_t2_start")
    onsite_co2_peat_t2_w = models.FloatField(null=True, blank=True, verbose_name="onsite_co2_peat_t2_w")
    onsite_co2_peat_t2_wo = models.FloatField(null=True, blank=True, verbose_name="onsite_co2_peat_t2_wo")

    onsite_n2o_peat_t2_start = models.FloatField(null=True, blank=True, verbose_name="onsite_n2o_peat_t2_start")
    onsite_n2o_peat_t2_w = models.FloatField(null=True, blank=True, verbose_name="onsite_n2o_peat_t2_w")
    onsite_n2o_peat_t2_wo = models.FloatField(null=True, blank=True, verbose_name="onsite_n2o_peat_t2_wo")

    offsite_doc_peat_t2_start = models.FloatField(null=True, blank=True, verbose_name="offsite_doc_peat_t2_start")
    offsite_doc_peat_t2_w = models.FloatField(null=True, blank=True, verbose_name="offsite_doc_peat_t2_w")
    offsite_doc_peat_t2_wo = models.FloatField(null=True, blank=True, verbose_name="offsite_doc_peat_t2_wo")

    offsite_ch4_peat_t2_start = models.FloatField(null=True, blank=True, verbose_name="offsite_ch4_peat_t2_start")
    offsite_ch4_peat_t2_w = models.FloatField(null=True, blank=True, verbose_name="offsite_ch4_peat_t2_w")
    offsite_ch4_peat_t2_wo = models.FloatField(null=True, blank=True, verbose_name="offsite_ch4_peat_t2_wo")

    peat_density_t2_start = models.FloatField(null=True, blank=True, verbose_name="peat_density_t2_start")
    peat_density_t2_w = models.FloatField(null=True, blank=True, verbose_name="peat_density_t2_w")
    peat_density_t2_wo = models.FloatField(null=True, blank=True, verbose_name="peat_density_t2_wo")
...
class Settlement(LandModuleFixed, SingleBiomassModule):
    settlement_type_start = models.ForeignKey(SettlementType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_settlement_type_start", verbose_name="settlement_type_start")
    settlement_type_w = models.ForeignKey(SettlementType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_settlement_type_w", verbose_name="settlement_type_w")
    settlement_type_wo = models.ForeignKey(SettlementType, on_delete=models.CASCADE, null=True, blank=True, related_name="%(class)s_settlement_type_wo", verbose_name="settlement_type_wo")
...
class SetAside(LandModule, SingleBiomassModule):
    is_set_aside_start = models.BooleanField(default=False, verbose_name="is_set_aside_start")
    is_set_aside_w = models.BooleanField(default=False, verbose_name="is_set_aside_w")
    is_set_aside_wo = models.BooleanField(default=False, verbose_name="is_set_aside_wo")
...
class OtherLand(LandModule, SingleBiomassModule):
    is_degraded_land_start = models.BooleanField(default=False, verbose_name="is_degraded_land_start")
    is_degraded_land_w = models.BooleanField(default=False, verbose_name="is_degraded_land_w")
    is_degraded_land_wo = models.BooleanField(default=False, verbose_name="is_degraded_land_wo")
...
class LandUseChange(Module):
    module_type_start = models.ForeignKey(ModuleType, on_delete=models.CASCADE, related_name="start", verbose_name="module_type_start")
    module_type_w = models.ForeignKey(ModuleType, on_delete=models.CASCADE, related_name="w", verbose_name="module_type_w")
    module_type_wo = models.ForeignKey(ModuleType, on_delete=models.CASCADE, related_name="wo", verbose_name="module_type_wo")
    ...
    dry_matter_start = models.FloatField(null=True, blank=True, default=0, verbose_name="dry_matter_start")
    dry_matter_w = models.FloatField(null=True, blank=True, default=0, verbose_name="dry_matter_w")
    dry_matter_wo = models.FloatField(null=True, blank=True, default=0, verbose_name="dry_matter_wo")
    ...
    organic_soil = models.OneToOneField(OrganicSoil, on_delete=models.CASCADE, null=True, blank=True, related_name="land_use_change_organic_soil", verbose_name="organic_soil")
...
class ValueChainParentModule(Module):
    class Meta:
        abstract = True

    @property
    def submodules(self) -> list["ValueChainSubmodule"]:
...
class StorageEntry(ValueChainSubmodule):
    parent = models.ForeignKey(Storage, on_delete=models.CASCADE, null=True, blank=True, related_name="entries")
...
class Processing(ValueChainParentModule):
    pass


class ProcessingEntry(ValueChainSubmodule):
    parent = models.ForeignKey(Processing, on_delete=models.CASCADE, null=True, blank=True, related_name="entries")
...
class Packaging(ValueChainParentModule):
    pass


class PackagingEntry(ValueChainSubmodule):
    parent = models.ForeignKey(Packaging, on_delete=models.CASCADE, null=True, blank=True, related_name="entries")
...
class Transport(ValueChainParentModule):
    pass
