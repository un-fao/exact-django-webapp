...
router.register(r"tillage-management-types", views.public_generic_viewset(models.TillageManagementType), basename="tillagemanagementtype")
...
router.register(r"grassland-management-types", views.public_generic_viewset(models.GrasslandManagementType), basename="grasslandmanagementtype")

# Fishery
router.register(r"small-fisheries", views.generic_module_viewset(models.SmallFishery), basename="smallfishery")
router.register(r"small-fishery-gear-types", views.public_generic_viewset(models.SmallFisheryGearType), basename="smallfisherygeartypes")

router.register(r"large-fisheries", views.generic_module_viewset(models.LargeFishery), basename="largefishery")
router.register(r"large-fishery-gear-types", views.public_generic_viewset(models.LargeFisheryGearType), basename="largefisherygeartypes")

router.register(r"fish-types", views.public_generic_viewset(models.FishType), basename="fishtypes")
router.register(r"fishery-types", views.public_generic_viewset(models.FisheryType), basename="fisherytypes")
...
router.register(r"irrigation-system-types", views.public_generic_viewset(models.IrrigationSystemType), basename="irrigationsystemtype")
...
router.register(r"salinity-types", views.public_generic_viewset(models.SalinityType), basename="salinitytype")

router.register(r"organic-input-types", views.public_generic_viewset(models.OrganicInputType), basename="organicinputtype")
router.register(r"macro-input-types", views.public_generic_viewset(models.MacroInputType), basename="macroinputtype")
router.register(r"input-types", views.InputTypeViewSet, basename="inputtype")
router.register(r"residue-management-types", views.public_generic_viewset(models.ResidueManagementType), basename="residuemanagementtype")

router.register(r"status-types", views.public_generic_viewset(models.StatusType), basename="statustype")
...
router.register(r"livestock-category-types", views.public_generic_viewset(models.LivestockCategoryType), basename="livestockcategorytypes")
router.register(r"livestock-production-types", views.public_generic_viewset(models.LivestockProductionType), basename="livestockproductiontypes")
router.register(r"manure-management-types", views.public_generic_viewset(models.ManureManagementType), basename="manuremanagementtypes")

# Forest Management
router.register(r"forest-managements", views.generic_module_viewset(models.ForestManagement), basename="forestmanagement")
router.register(r"disturbance-types", views.public_generic_viewset(models.DisturbanceType), basename="disturbancetypes")
router.register(r"forest-types", views.public_generic_viewset(models.ForestType), basename="foresttypes")
router.register(r"forest-condition-types", views.public_generic_viewset(models.ForestConditionType), basename="forestconditiontypes")
...
router.register(r"waterbody-types", views.public_generic_viewset(models.WaterbodyType), basename="waterbodytypes")
router.register(r"trophic-types", views.public_generic_viewset(models.TrophicType), basename="trophictypes")

# Settlements
router.register(r"settlements", views.generic_module_viewset(models.Settlement), basename="settlement")
router.register(r"settlement-types", views.public_generic_viewset(models.SettlementType), basename="settlementtypes")
...
router.register(r"road-types", views.public_generic_viewset(models.RoadType), basename="roadtypes")
router.register(r"building-types", views.public_generic_viewset(models.BuildingType), basename="buildingtypes")
...
router.register(r"fuel-use-types", views.public_generic_viewset(models.FuelUseType), basename="fuelusetypes")

# Organic Soil
router.register(r"fire-types", views.public_generic_viewset(models.FireType), basename="firetypes")
router.register(r"peat-types", views.public_generic_viewset(models.PeatType), basename="peattypes")
