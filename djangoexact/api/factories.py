...
class GrasslandFactory(DjangoModelFactory):
    ...
    fire_periodicity_start = factory.fuzzy.FuzzyInteger(0, 100)
    fire_periodicity_w = factory.fuzzy.FuzzyInteger(0, 100)
    fire_periodicity_wo = factory.fuzzy.FuzzyInteger(0, 100)
